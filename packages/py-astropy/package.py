...
class PyAstropy(PythonPackage):
    ...
    def setup_build_environment(self, env):
        env.set("CFLAGS", "-Wno-incompatible-function-pointer-types")
    ...
    def patch(self):
        ...
        #  filter_file("'-std=gnu99'", "'-std=gnu99', '-Wno-incompatible-function-pointer-types'", "astropy/wcs/setup_package.py")
